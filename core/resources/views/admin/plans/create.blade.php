            ...
            <form method="POST" action="{{ route('admin.plans.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-1-12">
                            <input type="number" class="form-control" name="price" value="{{ old('price') }}"
                                id="price" placeholder="Plan Price (0 = Free)">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="col-sm-1-12">
                            <input type="number" class="form-control" name="period" value="{{ old('period') }}"
                                id="period" placeholder="Duration (months)">
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <div class="col-sm-1-12">
                            <input type="text" class="form-control" name="earning_rate"
                                value="{{ old('earning_rate') }}" id="earning_rate"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="col-sm-1-12">
                            <input type="text" class="form-control" name="speed" value="{{ old('speed') }}"
                                id="speed" placeholder="Mining Speed (hours)">
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <div class="col-sm-1-12">
                            <input type="file" class="form-control" name="image" value="{{ old('image') }}"
                                id="image" placeholder="Plan Image">
                        </div>
                    </div>
                </div>
                <div class="row">
